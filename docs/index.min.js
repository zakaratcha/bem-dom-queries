...
/* begin: ./blocks/content/content.js */
modules.define('content', ['i-bem-dom'], function (provide, bemDom) {
    provide(bemDom.declBlock(this.name, {}));
});

/* end: ./blocks/content/content.js */
/* begin: ./blocks/test0/test0.js */
modules.define('test0', ['i-bem-dom'], function (provide, bemDom) {
    provide(bemDom.declBlock(this.name, {}));
});

/* end: ./blocks/test0/test0.js */
/* begin: ./blocks/testbox/testbox.js */
...
/* end: ./blocks/testbox/testbox.js */
/* begin: ./blocks/test1/test1.js */
...
/* end: ./blocks/test1/test1.js */
/* begin: ./blocks/test1/__el/test1__el.js */
modules.define('test1__el', ['i-bem-dom'], function (provide, bemDom) {
    provide(bemDom.declElem('test1', 'el', {}));
});

/* end: ./blocks/test1/__el/test1__el.js */
/* begin: ./blocks/test2/test2.js */
modules.define('test2', ['i-bem-dom'], function (provide, bemDom) {
    provide(bemDom.declBlock(this.name, {}));
});

/* end: ./blocks/test2/test2.js */
/* begin: ./blocks/pad/pad.js */
modules.define('pad', [
    'test0',
    'test1',
    'test1__el',
